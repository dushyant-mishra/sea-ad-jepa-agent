"""Explicit current-V5 production authority root vocabulary V2.

V1 intentionally kept a compact transitional root set. V2 promotes the
scientifically decisive masking, target, runtime, geometry and execution
qualifications to first-class roots so role splicing cannot hide behind
transitive digests.
"""
