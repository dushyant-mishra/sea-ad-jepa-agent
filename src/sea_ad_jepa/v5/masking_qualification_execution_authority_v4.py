"""Masking execution authority V4 bound to the canonical current decision rule."""
...
class MaskingQualificationExecutionAuthorityV4:
    authority_id: str
    ...
    def canonical_digest(self) -> str:
        self.validate()
        return _digest({"schema": "V5_MASKING_QUALIFICATION_EXECUTION_AUTHORITY_V4", **asdict(self)})
