...
from full104_production_expression_firewall import assert_fit_only_nph_assets,run_negative_firewall_selftests
...
OUT=PACKAGE/"interface_check_v8r1"
...
def execute():
 ...
 run_negative_firewall_selftests(auth["original_nph_denylist"],PACKAGE)
