...
# STOP unless a separately justified numerical null-equivalence-margin authority has been frozen.
# Unit-test fixtures (including 1/100 = 0.01) are NOT production authority.
# Do not derive this margin from realized terminal negative-control width.
$NULL_MARGIN_NUMERATOR = <REQUIRED_FROZEN_NUMERICAL_NULL_EQUIVALENCE_MARGIN_AUTHORITY_NUMERATOR>
$NULL_MARGIN_DENOMINATOR = <REQUIRED_FROZEN_NUMERICAL_NULL_EQUIVALENCE_MARGIN_AUTHORITY_DENOMINATOR>
