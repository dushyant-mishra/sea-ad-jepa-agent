...
- Active experimental PR **#77**, branch `analysis/perturbation-etl-gse301119-claude-20260923`, audited head **`67981c8ef6e158d865470e70bca81cbe289be3dd`**, DRAFT, base `analysis/therapeutic-perturbation-etl-20260923`. Re-fetch before editing. The latest head differs from the prior code head by one new versioned comparison receipt only. At audit time its CI rerun had **8 SUCCESS, 1 IN_PROGRESS, 0 FAILED**; the immediately preceding code-equivalent head had all nine workflows SUCCESS. Re-check before acting. New integration after the earlier audit: previously reviewed PR #84 -> #88 -> #90 baseline/exposure code was integrated from PR #99; see benchmark section below.
