...
PY |
| install_scenicplus | cd /tmp && rm -rf scenicplus && git clone https://github.com/aertslab/scenicplus && cd scenicplus && git checkout development && (conda run -n sea-ad-scenicplus python -m pip install . // (conda run -n sea-ad-scenicplus python -m pip install 'poetry<1.2' poetry-core hatchling 'packaging>=24.2' && conda run -n sea-ad-scenicplus python -m pip install --no-build-isolation .)) |
