...
def test_v4_source_manifest_discovers_full_canonical_surface() -> None:
...
def test_v4_active_selection_is_exact_and_contains_self() -> None:
    ...
    assert all("integration_freeze_v3" not in path for path in tests)
