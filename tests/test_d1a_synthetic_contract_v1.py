...
from scripts.agent.validate_d1a_synthetic_contract_v1 import validate_contract

CONTRACT = Path("docs/agent/D1A_SYNTHETIC_ESTIMATION_ATLAS_CONTRACT_20260907.json")
